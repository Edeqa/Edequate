...
function AdminsHolder(main) {
    ...
    this.resume = function() {
        u.clear(div);
        var titleNode = u.create(HTML.H2, "Admins", div);

        u.create(HTML.BUTTON, { className:"icon notranslate button-inline", innerHTML: "add", title:"Add admin", onclick: function(){
